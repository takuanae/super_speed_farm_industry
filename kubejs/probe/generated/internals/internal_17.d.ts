...
declare namespace Internal {
    ...
    class BufferBuilder extends Internal.DefaultedVertexConsumer implements Internal.ExtendedBufferBuilder, Internal.VertexBufferWriter, Internal.BufferVertexConsumer, Internal.IBufferBuilder {
        constructor(arg0: number)
    ...
    class PlayState extends Internal.Enum<Internal.PlayState> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.PlayState>>;
        getDeclaringClass(): typeof Internal.PlayState;
        toString(): string;
        notifyAll(): void;
        static values(): Internal.PlayState[];
        "compareTo(software.bernie.geckolib.core.object.PlayState)"(arg0: Internal.PlayState_): number;
        compareTo(arg0: Internal.PlayState_): number;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        ...
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.PlayState
        static readonly STOP: (Internal.PlayState) & (Internal.PlayState);
    ...
    class InputConstants$Key implements Internal.AccessInputConstantsKey {
        ...
        static controlling$getNAME_MAP_$md$86472a$0(): Internal.Map<any, any>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        wait(): void;
    ...
    abstract class MinecraftServer extends Internal.ReentrantBlockableEventLoop<Internal.TickTask> implements Internal.MinecraftServerKJS, Internal.CommandSource, Internal.AutoCloseable {
        ...
        */
        ...
        localvar$zgh000$wrapResourceManager(original: Internal.CloseableResourceManager_): Internal.CloseableResourceManager;
    ...
    interface IMutableModel {
        abstract getEmoteSupplier(): Internal.SetableSupplier<Internal.AnimationProcessor>;
        abstract setEmoteSupplier(arg0: Internal.SetableSupplier_<Internal.AnimationProcessor>): void;
        get emoteSupplier(): Internal.SetableSupplier<Internal.AnimationProcessor>
        set emoteSupplier(arg0: Internal.SetableSupplier_<Internal.AnimationProcessor>)
    }
    ...
    class LevelRenderer implements Internal.ResourceManagerReloadListener, Internal.WorldRendererAccessor, Internal.WorldRendererExtended, Internal.AutoCloseable {
        ...
        wrapWithCondition$zig000$redirectSetSkyShader(instance: Internal.VertexBuffer_, viewMatrix: Matrix4f_, projectionMatrix: Matrix4f_, program: Internal.ShaderInstance_): boolean;
        ...
        wait(): void;
        getTicks(): number;
        wrapOperation$zio000$redirectGetStarBrightness(instance: Internal.ClientLevel_, f: number, original: Internal.Operation_<any>): number;
        ...
        */
        ...
        handler$zjp000$renderCloudsFast(arg0: Internal.PoseStack_, arg1: Matrix4f_, arg2: number, arg3: number, arg4: number, arg5: number, arg6: Internal.CallbackInfo_): void;
        static addChainedFilledBoxVertices(arg0: Internal.PoseStack_, arg1: Internal.VertexConsumer_, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number, arg11: number): void;
        wait(arg0: number, arg1: number): void;
        ...
        getName(): string;
        wrapOperation$zja000$redirectGetFogColorOverride(instance: Internal.DimensionSpecialEffects_, skyAngle: number, tickDelta: number, original: Internal.Operation_<any>): number[];
        ...
        hashCode(): number;
        handler$zig000$preRenderEndSky(matrices: Internal.PoseStack_, ci: Internal.CallbackInfo_): void;
        getWeatherTarget(): Internal.RenderTarget;
        close(): void;
        clear(): void;
        wait(arg0: number): void;
        handler$zhk000$tickRainSplashing(camera: Internal.Camera_, callbackInfo: Internal.CallbackInfo_): void;
    ...
    type ICastData_ = (()=> void) | ICastData;
