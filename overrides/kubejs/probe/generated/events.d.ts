...
declare const ISSEvents: {
    /**
     * @at *startup*
    */
modifySpell(handler: (event: Internal.SpellModificationEventJS) => void):void,
};
...
death(handler: (event: Internal.LivingEntityDeathEventJS) => void):void,
     ...
     * @cancellable
    */
spellPreCast(handler: (event: Internal.EntitySpellPreCastEventJS) => void):void,
    /**
     * @at *server*
    */
spellOnCast(handler: (event: Internal.EntitySpellCastEventJS) => void):void,
    /**
